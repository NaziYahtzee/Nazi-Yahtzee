...
function rollDice(el){
    var timer = setInterval(function(){
        ...
        el.style.backgroundImage = "url("+diceNum+".jpg)";
    }, 125);
    setTimeout(function(){
        clearInterval(timer)
    },1000)
    ...
    if(rollNum < 3) {
        if(h1 == false){
            var timer1 = setInterval(function(){
                ...
                dice1.style.backgroundImage = "url("+diceVal1+".jpg)";
            }, 125)
            setTimeout(function(){
        ...
        if(h2 == false){
            var timer2 = setInterval(function(){
                ...
                dice2.style.backgroundImage = "url("+diceVal2+".jpg)";
            }, 125)
            setTimeout(function(){
        ...
        if(h3 == false){
            var timer3 = setInterval(function(){
                ...
                dice3.style.backgroundImage = "url("+diceVal3+".jpg)";
            }, 125)
            setTimeout(function(){
        ...
        if(h4 == false){
            var timer4 = setInterval(function(){
                ...
                dice4.style.backgroundImage = "url("+diceVal4+".jpg)";
            }, 125)
            setTimeout(function(){
        ...
        if(h5 == false){
            var timer5 = setInterval(function(){
                ...
                dice5.style.backgroundImage = "url("+diceVal5+".jpg)";
            }, 125)
            setTimeout(function(){
